// Program to check if given point lies inside or outside polygon
#include<iostream>
using namespace std;
...
{
    //for case 1
    Point polygon1[] = {{1, 0}, {8, 3}, {8, 8}, {8, 5}}; 
    int n = sizeof(polygon1)/sizeof(polygon1[0]); 
    Point p = {3, 5}; 
    checkInside(polygon1, n, p)? cout << "Ture \n": cout << "False \n"; 
    
    //for case 2
    Point polygon2[] = {{-3, 2}, {-2,-0.8}, {0, 1.2}, {2.2,0}, {2,4.5}}; 
    p = {0, 0}; 
    n = sizeof(polygon2)/sizeof(polygon2[0]); 
    checkInside(polygon2, n, p)? cout << "True \n": cout << "False \n"; 
    return 0;
}
